        ...
        if hasattr(chunk.choices[0].delta, 'content') and chunk.choices[0].delta.content is not None:
            ...
            if '题' in content.lower():
                ...
                if title[4:] != '':
                    ...
                    send_request('http://localhost:5000/title', serializable_response)
                    title = ''
                    found_title = False
            ...
            if '数' in content.lower():
                ...
                if bullet_points != '':
                    ...
                    serializable_response = json.loads(json.dumps(response, default=convert_to_serializable))
                    send_request('http://localhost:5000/bullet_points', serializable_response)
            ...
            if '始' in content.lower():
                ...
                if start[4:] != '':
                    ...
                    serializable_response = json.loads(json.dumps(response, default=convert_to_serializable))
                    send_request('http://localhost:5000/start', serializable_response)
            ...
            if '图' in content.lower():
                ...
                if during_drawing[4:] != '':
                    ...
                    serializable_response = json.loads(json.dumps(response, default=convert_to_serializable))
                    send_request('http://localhost:5000/during_writing', serializable_response)
            ...
            if '暂' in content.lower():
                ...
                if pause[4:] != '':
                    ...
                    serializable_response = json.loads(json.dumps(response, default=convert_to_serializable))
                    send_request('http://localhost:5000/pause', serializable_response)
            ...
            if '停' in content.lower():
                ...
                if stop[4:] != '':
                    ...
                    serializable_response = json.loads(json.dumps(response, default=convert_to_serializable))
                    send_request('http://localhost:5000/stop', serializable_response)
